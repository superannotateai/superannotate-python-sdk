...
class BaseProjectCleanUp(TestCase):
    """Base class for project clean up. Use for multiple projects clean up."""
...
class TestCreateMultimodalProject(BaseProjectCleanUp):
