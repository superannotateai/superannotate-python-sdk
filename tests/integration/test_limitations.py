...
class TestLimitsUploadImagesFromFolderToProject(BaseTestCase):
    ...
    @patch("lib.infrastructure.serviceprovider.ServiceProvider.get_limitations", return_value=folder_limit_response)
    ...
    @patch("lib.infrastructure.serviceprovider.ServiceProvider.get_limitations", return_value=project_limit_response)
    ...
    @patch("lib.infrastructure.serviceprovider.ServiceProvider.get_limitations", return_value=user_limit_response)
